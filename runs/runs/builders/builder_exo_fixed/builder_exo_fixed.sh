#!/bin/bash
#SBATCH --job-name=builder_exo_fixed
#SBATCH --nodes=1
#SBATCH --exclude=lustre,cernnode02,cernnode03,nut01,nut02
#SBATCH --output=builder_exo_fixed.log
#SBATCH --error=builder_exo_fixed.err
#SBATCH --ntasks=4
...
echo "======================================================"
echo "Covmat builder builder_exo_fixed started on $(hostname) at $(date)"
echo "======================================================"
...
max_retries=10
retry_count=0
command="mpirun -np $SLURM_NTASKS cobaya-run builder_exo_fixed.yaml --resume"
...
# cobaya writes outputs/builder_exo_fixed.covmat at convergence-check cycles. If the run
...
import os, sys
import numpy as np
chain_root = os.path.join('outputs', 'builder_exo_fixed')
try:
...
echo "======================================================"
echo "Builder builder_exo_fixed finished at $(date). Covmat at outputs/builder_exo_fixed.covmat"
echo "======================================================"
