#!/bin/bash
#SBATCH --job-name=builder_lcdm_vbeta
#SBATCH --nodes=1
#SBATCH --exclude=lustre,cernnode02,cernnode03,nut01,nut02
#SBATCH --output=builder_lcdm_vbeta.log
#SBATCH --error=builder_lcdm_vbeta.err
#SBATCH --ntasks=4
...
echo "======================================================"
echo "Covmat builder builder_lcdm_vbeta started on $(hostname) at $(date)"
echo "======================================================"
...
max_retries=10
retry_count=0
command="mpirun -np $SLURM_NTASKS cobaya-run builder_lcdm_vbeta.yaml --resume"
...
# cobaya writes outputs/builder_lcdm_vbeta.covmat at convergence-check cycles. If the run
...
import os, sys
import numpy as np
chain_root = os.path.join('outputs', 'builder_lcdm_vbeta')
try:
...
echo "======================================================"
echo "Builder builder_lcdm_vbeta finished at $(date). Covmat at outputs/builder_lcdm_vbeta.covmat"
echo "======================================================"
