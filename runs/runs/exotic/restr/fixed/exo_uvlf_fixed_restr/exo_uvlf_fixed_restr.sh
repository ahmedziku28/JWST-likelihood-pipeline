#!/bin/bash
#SBATCH --job-name=exo_uvlf_fixed_restr
#SBATCH --nodes=1
#SBATCH --exclude=lustre,cernnode02,cernnode03,nut01,nut02,nut05
#SBATCH --output=exo_uvlf_fixed_restr.log
#SBATCH --error=exo_uvlf_fixed_restr.err
#SBATCH --ntasks=8
...
max_retries=50
retry_count=0
command="mpirun -np $SLURM_NTASKS cobaya-run exo_uvlf_fixed_restr.yaml --resume"
