#!/bin/bash
#SBATCH --job-name=exo_ceers_cmb_fixed_restr
#SBATCH --nodes=1
#SBATCH --exclude=lustre,cernnode02,cernnode03,nut01,nut02
#SBATCH --output=exo_ceers_cmb_fixed_restr.log
...
max_retries=50
retry_count=0
command="mpirun -np $SLURM_NTASKS cobaya-run exo_ceers_cmb_fixed_restr.yaml --resume"
