#!/bin/bash
#SBATCH --job-name=exo_ceers_bg_vbeta_restr
#SBATCH --nodes=1
#SBATCH --exclude=nut05
#SBATCH --output=exo_ceers_bg_vbeta_restr.log
#SBATCH --error=exo_ceers_bg_vbeta_restr.err
#SBATCH --ntasks=8
...
max_retries=50
retry_count=0
command="mpirun -np $SLURM_NTASKS cobaya-run exo_ceers_bg_vbeta_restr.yaml --resume"
