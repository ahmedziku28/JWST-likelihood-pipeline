#!/bin/bash
#SBATCH --job-name=lcdm_uvlf_bg_fixed_restr
#SBATCH --nodes=1
#SBATCH --exclude=nut05
#SBATCH --output=lcdm_uvlf_bg_fixed_restr.log
#SBATCH --error=lcdm_uvlf_bg_fixed_restr.err
#SBATCH --ntasks=8
...
max_retries=50
retry_count=0
command="mpirun -np $SLURM_NTASKS cobaya-run lcdm_uvlf_bg_fixed_restr.yaml --resume"
