#!/bin/bash
#SBATCH --job-name=lcdm_uvlf_fixed_full
#SBATCH --nodes=1
#SBATCH --exclude=lustre,cernnode02,cernnode03,nut01,nut02
#SBATCH --output=lcdm_uvlf_fixed_full.log
#SBATCH --error=lcdm_uvlf_fixed_full.err
#SBATCH --ntasks=8
...
max_retries=50
retry_count=0
command="mpirun -np $SLURM_NTASKS cobaya-run lcdm_uvlf_fixed_full.yaml --resume"
