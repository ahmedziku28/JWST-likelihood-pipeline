#!/bin/bash
#SBATCH --job-name=lcdm_uvlf_vshmr_full
#SBATCH --nodes=1
#SBATCH --exclude=nut05
#SBATCH --output=lcdm_uvlf_vshmr_full.log
#SBATCH --error=lcdm_uvlf_vshmr_full.err
#SBATCH --ntasks=8
...
max_retries=50
retry_count=0
command="mpirun -np $SLURM_NTASKS cobaya-run lcdm_uvlf_vshmr_full.yaml --resume"
