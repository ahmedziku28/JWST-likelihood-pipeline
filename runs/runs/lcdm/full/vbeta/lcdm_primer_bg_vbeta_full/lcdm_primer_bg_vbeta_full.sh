#!/bin/bash
#SBATCH --job-name=lcdm_primer_bg_vbeta_full
#SBATCH --nodes=1
#SBATCH --exclude=lustre,cernnode02,cernnode03,nut01,nut02
#SBATCH --output=lcdm_primer_bg_vbeta_full.log
#SBATCH --error=lcdm_primer_bg_vbeta_full.err
#SBATCH --ntasks=8
...
max_retries=50
retry_count=0
command="mpirun -np $SLURM_NTASKS cobaya-run lcdm_primer_bg_vbeta_full.yaml --resume"
