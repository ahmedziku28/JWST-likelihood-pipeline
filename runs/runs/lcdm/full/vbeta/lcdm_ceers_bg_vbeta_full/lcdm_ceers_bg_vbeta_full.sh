#!/bin/bash
#SBATCH --job-name=lcdm_ceers_bg_vbeta_full
#SBATCH --nodes=1
#SBATCH --exclude=lustre,cernnode02,cernnode03,nut01,nut02,nut05
#SBATCH --output=lcdm_ceers_bg_vbeta_full.log
#SBATCH --error=lcdm_ceers_bg_vbeta_full.err
#SBATCH --ntasks=8
...
max_retries=50
retry_count=0
command="mpirun -np $SLURM_NTASKS cobaya-run lcdm_ceers_bg_vbeta_full.yaml --resume"
